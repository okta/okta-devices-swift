...
In your browser, navigate to: [https://github.com/okta/okta-devices-swift](https://github.com/okta/okta-devices-swift)
...
``` bash
$ git clone https://github.com/YOUR_ACCOUNT/okta-devices-swift.git
$ cd okta-devices-swift
$ git remote add upstream https://github.com/okta/okta-devices-swift.git
$ git checkout master
$ git fetch upstream
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/okta-devices-swift](https://github.com/YOUR_ACCOUNT/okta-devices-swift)
