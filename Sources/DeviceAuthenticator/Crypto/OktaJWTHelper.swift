...
//The following code taken from JOSE Swift library
...
func toRaw(_ data: Data, of fixedLength: Int) -> Data {
...
enum ASN1DERParsingError: Error {
...
func readTag(from encodedTriplet: [UInt8], pointer: inout Int) -> UInt8 {
...
func readLengthField(from encodedTriplet: [UInt8], pointer: inout Int) throws -> [UInt8] {
...
func readValueField(ofLength length: Int, from encodedTriplet: [UInt8], pointer: inout Int) throws -> [UInt8] {
...
func length(encodedBy lengthField: [UInt8]) throws -> Int {
