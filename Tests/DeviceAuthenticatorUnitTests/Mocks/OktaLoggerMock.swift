...
class OktaLoggerDestinationMock: OktaLoggerDestinationProtocol {
    ...
    var level: OktaLoggerLogLevel = []

    var defaultProperties: [AnyHashable: Any] = [:]

    func log(level: OktaLoggerLogLevel, eventName: String, message: String?, properties: [AnyHashable: Any]?, file: String, line: NSNumber, funcName: String) {
    }
