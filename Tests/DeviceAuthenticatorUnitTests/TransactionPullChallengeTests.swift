...
class TransactionPullChallengeTests: XCTestCase {
    ...
    override func setUp() {
        ...
        restAPIClient = OktaRestAPI(client: mockHTTPClient, logger: OktaLoggerMock())
    }
    ...
    func testPendingChallenge_Success() {
        ...
        var restAPIClient = OktaRestAPI(client: mockHTTPClient, logger: OktaLoggerMock())
