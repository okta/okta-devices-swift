...
class OktaAuthenticatorsManagerTests: XCTestCase {
    ...
    func testUpdateEnrollment_LifecycleErrors() {
        ...
        authenticatorManager.restAPI = MyAccountServerAPI(client: mockHTTPClient,
